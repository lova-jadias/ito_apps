...
serve(async (req) => {
  ...
  try {
    console.log('🔵 [1/5] Initialisation Supabase Admin')
    ...
    console.log('🔵 [2/5] Récupération utilisateur authentifié')
    ...
    console.log('🔵 [3/5] Parsing body')
    const body = await req.json()
    const { student_data, temp_password, activate_gojika } = body
    console.log('📦 Body reçu:', JSON.stringify(body, null, 2))

    console.log('🔵 [4/5] Validation RPC prepare_student_data')
    ...
    console.log('🔵 [5/5] Création utilisateur auth')
